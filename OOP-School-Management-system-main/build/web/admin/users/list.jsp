      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="flex" style="display: flex; gap: 24px; align-items: center;">
            ...
            <button type="button" class="btn btn-success" style="max-height: 35px;"><a href="UserServlet?action=add"><i class="fa fa-plus" aria-hidden="true"></i></a></button>
          </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                    ...
                    <td><%= per.getRole()%></td>
                    <td>
                            <a class="btn btn-warning" href="UserServlet?action=edit&id=<%= per.getUserId()%>">Edit</a>
                            <a class="btn btn-danger" href="UserServlet?action=delete&id=<%= per.getUserId()%>">Remove</a>
                    </td>
                </tr>
                <%}%>
              </tbody>
