    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Edit Attendance</h2>
          <div class="user-form" style="width: 50%;">
            ...
            <form>
              ...
              <div class="form-group">
                ...
                <input name="txtAttendance" type="checkbox"  id="txtAttendance"  value="<%= sa.getAttendance()%>">
              </div>
              
                <input type="hidden" name="txtStudentId" value="<%= sa.getStudentId()%>">
