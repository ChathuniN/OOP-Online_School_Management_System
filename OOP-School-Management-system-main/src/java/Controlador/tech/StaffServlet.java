...
@WebServlet(name = "TechStaffServlet", urlPatterns = {"/TechStaffServlet"})
public class StaffServlet extends HttpServlet {
    
    // Get url patterns to variables
    String list="tech/staff/list.jsp";
    String add="tech/staff/add.jsp";
    String edit="tech/staff/edit.jsp";    
