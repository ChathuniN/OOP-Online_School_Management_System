      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="QuizServlet?action=list"><i class="fa fa-sitemap" aria-hidden="true"></i>Quiz</a></li>
            <li><a href="reports/reportpool.jsp"><i class="fa fa-sitemap" aria-hidden="true"></i>Reports</a></li>
