      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="user-form" style="width: 50%;">
              ...
              Course st=(Course)dao.list(id);
              %>
            <form>
              
              <div class="form-group">
                <label for="txtCourseName">Course Name</label>
                <input name="txtCourseName" type="text" class="form-control" id="txtCourseName" placeholder="Enter the Course Name" value="<%= st.getCourseName()%>" required>
              </div>
              <div class="form-group">
                <label for="txtDescription">Description</label>
                <textarea name="txtDescription" type="text" class="form-control" id="txtDescription" placeholder="Enter Course Description"><%= st.getDescription()%></textarea>
              </div>
                             
                <input type="hidden" name="txtCourseId" value="<%=st.getCourseId()%>">
