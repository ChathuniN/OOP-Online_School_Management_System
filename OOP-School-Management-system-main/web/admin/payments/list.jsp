...
<%@page import="ModeloDAO.PaymentDAO"%>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="PaymentServlet?action=list"><i class="fa fa-sitemap" aria-hidden="true"></i>Payments</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="table table-striped">
            ...
            <%
                ...
                List<Payment>list=dao.list_array();
                Iterator<Payment>iter=list.iterator();
                Payment st=null;
                while(iter.hasNext()){
                    st=iter.next();  
              %>
