      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href=""><i class="fa fa-sitemap" aria-hidden="true"></i>Reports<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">Reports Pool</h2>
          </div>
          ...
          <section class="report-flex">
            <div class="report-tile">
              ...
              <div class="name">
                <a href="../../StudentReportServlet?action=list">Student Report</a>
              </div>
            </div>
          </section>
        </div>
