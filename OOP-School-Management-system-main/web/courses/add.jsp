      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li  class="active"><a href="org.html">Organization<span class="sr-only">(current)</span></a></li>
          ...
          <div class="user-form" style="width: 50%;">
            <form action="CourseServlet">
             <div class="form-group">
                ...
                <input name="txtCourseName" type="text" class="form-control" id="txtCourseName" placeholder="Enter Course Name">
              </div>
