          ...
          <div class="user-form" style="width: 50%;">
            <form action="ExamServlet">
              <div class="form-group">
                ...
                <input name="txtExamCode" type="text" class="form-control" id="txtExamCode" placeholder="Enter Exam Code">
              </div>
              <div class="form-group">
                <label for="txtExamName">Exam Name</label>
                <input name="txtExamName" type="text" class="form-control" id="txtExamName" placeholder="Enter the Exam">
              </div>
              <div class="form-group">
