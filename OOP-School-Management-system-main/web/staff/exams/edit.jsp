        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="user-form" style="width: 50%;">
            ...
            <form>
                ...
                <input name="txtExamCode" type="text" class="form-control" id="txtExamCode" placeholder="Enter Exam Code" value="<%= ex.getExamCode()%>" required>
              </div>
              <div class="form-group">
                <label for="txtExamName">Exam Name</label>
                <input name="txtExamName" type="text" class="form-control" id="txtExamName" placeholder="Enter the Exam" value="<%= ex.getExamName()%>" required>
              </div>
              <div class="form-group">
