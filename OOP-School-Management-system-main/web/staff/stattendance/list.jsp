      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="flex" style="display: flex; gap: 24px; align-items: center;">
            <h2 class="sub-header">Student Attendance</h2>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>
                    <a class="btn btn-warning" href="StattendanceServlet?action=edit&id=<%= sa.getStudentId()%>">Edit</a>
                    <a class="btn btn-danger" href="StattendanceServlet?action=delete&id=<%= sa.getStudentId()%>">Delete</a>
                </td>
              </tr>
              <%}%>
            </tbody>
